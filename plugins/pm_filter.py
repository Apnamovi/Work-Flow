...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [   
	    InlineKeyboardButton(text='⚡Join Backup Channel⚡', url=f'https://t.me/Moviesadda24_7s')
        ]   
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            return await query.answer('♥️ Love @LusiFilms ♥️')
        ...
        return await query.answer('♥️ Love @LisiFilms ♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('📥 Join Backup Channel 📥', url=f'https://t.me/Moviesadda24_7s')
            ],[
    ...
    if not spoll:
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                await message.reply_text(text=f"△ 𝙷𝚎𝚢 𝚜𝚘𝚗𝚊 `{message.from_user.first_name}` 😎,\n\nमूवी नहीं मिल रही है तो सिर्फ मूवी का नाम लिखें\nमूवी का नाम कैसे लिखना है ये देखे\n👇👇👇👇\n\nमूवी का नाम इस तरह से न लिखे\n\nMari 2 ❌\nPuspa ❌\nLucifer ❌\nAvatar: The Way of Water ❌\n\nमूवी का नाम इस तरह से लिखें\n👇👇👇👇\n\n👉 Maari 2 2018 ✅\n👉 Pushpa 2021 ✅\n👉 Lucifer S01E01 ✅\n👉 Avatar The Way of Water ✅\nमूवी का नाम सही है फिर भी मूवी नही मिल रही है तो मूवी 24 घंटे के अंदर ग्रुप में आ जाएगी\n\n➟ 📝Movie Name : `{search}`\n➟ 👮Requested By: `{message.from_user.first_name}`\n\nJoin BackUp 👉 <a herf=https://t.me/Moviesadda24_7s>♥️ Movies Adaa ♥️</a>",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('Cʟɪᴄᴋ Tᴏ Cʜᴇᴄᴋ Sᴘᴇʟʟɪɴɢ 📝', url=f'https://google.com/search?q={search}%20Movie')],[InlineKeyboardButton('Cʟɪᴄᴋ Tᴏ Cʜᴇᴄᴋ Rᴇʟᴇᴀꜱᴇ Dᴀᴛᴇ 📅', url=f'https://google.com/search?q={search}%20Movie%20Release%20Date')]]))
