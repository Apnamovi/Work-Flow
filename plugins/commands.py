...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f'https://t.me/Letest_All_Type_Movies'),
            ],
            [
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('📥 Join BackUp Channel 📥', url='https://t.me/Moviesadda24_7s')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
